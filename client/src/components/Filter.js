...
import { FILTER_BY_DATA } from "../actions/types";
        ...
        <div className="filter--container d-flex justify-content-center pb-2 pt-2 mb-3">
            <div className="szuresInner d-flex align-items-center mr-4">
                ...
                <div className="form-group mr-1 mr-md-3 mb-0">
                    ...
                    <input type="text" className="form-control" placeholder="pl: gitár" name="instrument" onInput={(e) => onChange(e)} />
                </div>
                ...
                <div className="pt-3 ml-2">
                    ...
                    <div className="form-group mb-0">
                        <div className="form-check">
                            ...
                            />
                            <label className="form-check-label" htmlFor="zeneszek">
                                zenészek
                            </label>
                        </div>
                        ...
                        <div className="form-check">
                            ...
                            />
                            <label className="form-check-label" htmlFor="zenekarok">
                                zenekarok
                            </label>
                        </div>
                    </div>
