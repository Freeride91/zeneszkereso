            ...
            <div className="controlMaxWidth1200">
                ...
                <div className='hirdetes'>
                    ...
                    <div className="d-md-flex justify-content-end kapcsolatDetails">
                        ...
                        <span className="ml-4"><i className="far fa-envelope"></i> {post.email ? post.email : '-'}</span>
                        <span className="ml-4"><i className="fas fa-mobile-alt"></i> {post.phoneNum ? post.phoneNum : '-'}</span>
                    </div>
