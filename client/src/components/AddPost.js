...
const AddPost = ({ posts: { post, editing }, auth: { user, isAuthenticated }, history, newPost, editPost }) => {
        ...
        <div className="new-post-card">
            ...
            <form className="form newAdForm" action="#" onSubmit={(e) => onSubmit(e)}>
                ...
                <div className="form-group d-md-flex justify-content-between">
                    <label className="font-weight-bold" htmlFor="hirdeto_type">
                        Hirdető:{" "}
                    </label>
                    <div className="form-check">
                        <input
                            ...
                            value="person"
                        />
                        <label className="form-check-label" htmlFor="persOrBand">
                            zenész (zenekart keresek)
                        </label>
                    </div>
                    <div className="form-check">
                        <input
                ...
                <div className="form-group mb-1">
                    <div className="divideFlexInput">
                        <label htmlFor="instrument" className="mt-2">
                            <i className="fas fa-guitar"></i> &nbsp;Hangszer:
                        </label>
                        <input
                ...
                <div className="form-group">
                    <div className="divideFlexInput">
                        <label htmlFor="place" className="mt-2">
                            <i className="fas fa-street-view"></i> &nbsp;Helyszín:
                        </label>
                        <SuggestInput suggestValues={telepulesek} onSuggestValueChange={onPlaceSuggestChange} value={formData.place} />
                    </div>
                </div>
                <div className="form-group">
                    <label htmlFor="description">
                        <i className="far fa-file-alt"></i> &nbsp;<b>Hirdetés szövege:</b>
                    </label>
                    <textarea
                ...
                <div className="form-group">
                    <div className="divideFlexInput">
                        <label htmlFor="phoneNum" className="mt-2">
